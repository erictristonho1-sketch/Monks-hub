...
local Ativo = { Steal = false, Goal = false, Shot = false, Dive = false }
...
if UIS.TouchEnabled then
    task.spawn(function()
        ...
        if diveBtn then diveBtn.MouseButton1Click:Connect(function() task.spawn(autoDive) end) end
        if shootBtn then 
...
print(">> Script Atualizado com Auto Dive ✅")
